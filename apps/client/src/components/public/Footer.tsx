      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="flex items-center gap-4 w-full md:w-1/3">
            ...
            <div className="ml-2">
              <span className="text-white text-2xl font-bold block leading-tight font-serif">Andorra la Vella</span>
          ...
          <div className="w-full md:w-1/3 space-y-6">
            <div>
              <p className="text-sm text-white/90 leading-relaxed max-w-xs">
                Av. de Santa Coloma, 42, AD500<br/>
            ...
            <div>
              <p className="text-sm text-white/90 leading-relaxed max-w-xs">
                University Office : +376 876 999<br/>
                Fax : +376 876 999
              </p>
              <button className="flex items-center gap-1 text-xs font-bold mt-2 hover:text-[#ffcc00] transition-colors">
                Directions <ChevronRight className="w-3 h-3" />
