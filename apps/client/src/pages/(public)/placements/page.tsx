  ...
  return (
    <div className="min-h-screen bg-[#ffffff]">
      ...
      <section className="relative pt-32 pb-24 bg-[#8a1538] text-white overflow-hidden min-h-[50vh] flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#8a1538] via-[#8a1538]/80 to-transparent"></div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {[
            ...
            <GsapReveal key={i}>
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center hover:-translate-y-2 transition-transform">
                ...
                <h3 className="text-4xl font-black text-[#8a1538] mb-2">{stat.value}</h3>
        ...
        <GsapReveal>
          <div className="bg-[#8a1538] rounded-3xl p-12 text-center text-white overflow-hidden relative">
