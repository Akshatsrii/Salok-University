  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 animate-reveal">
      ...
      <form className="space-y-5">
        ...
        <div className="space-y-1">
          <label className="text-xs font-semibold text-gray-700 ml-1">Program of Interest</label>
          <div className="relative">
            <BookOpen className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
            <select className="w-full bg-gray-50 border border-gray-200 rounded-xl py-2.5 pl-9 pr-3 outline-none focus:bg-white focus:border-[#007bff] focus:ring-2 focus:ring-[#007bff]/20 transition-all text-sm appearance-none text-gray-700">
        ...
        <button type="button" className="w-full bg-[#ffb800] hover:bg-[#e6a600] text-[#1a2b4c] font-bold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2 group shadow-md shadow-[#ffb800]/20 mt-4">
          Create Account
      ...
      <p className="text-center mt-6 text-sm text-gray-600">
        Already have an account? <Link href="/login" className="font-bold text-[#007bff] hover:underline">Sign In</Link>
      </p>
    </div>
  );
}
