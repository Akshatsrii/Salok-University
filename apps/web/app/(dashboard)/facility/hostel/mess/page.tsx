...
import { MessMenuEditor } from '../../../../../components/hostel/MessMenuEditor';
import { MessAttendanceTable } from '../../../../../components/hostel/MessAttendanceTable';

export default function FacilityHostelMessPage() {
  return (
